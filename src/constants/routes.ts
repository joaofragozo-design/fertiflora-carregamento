...
export const ROLE_ALLOWED_ROUTES: Record<string, string[]> = {
  operador_carregamento: [ROUTES.CARREGAMENTO],
  operador_pa:           [ROUTES.PA],
  admin:                 [ROUTES.CARREGAMENTO, ROUTES.PA, ROUTES.ORDENS, ROUTES.PROGRAMACAO, ROUTES.RECEBIMENTO, ROUTES.ADMIN_FORMULAS, ROUTES.TRANSPORTADORA, ROUTES.TRANSPORTADORAS, ROUTES.SOLICITACOES],
  logistica:             [ROUTES.ORDENS, ROUTES.PROGRAMACAO, ROUTES.RECEBIMENTO, ROUTES.ADMIN_FORMULAS, ROUTES.TRANSPORTADORAS, ROUTES.SOLICITACOES],
